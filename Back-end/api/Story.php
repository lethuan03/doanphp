...
try {
    if ($method === 'GET') {
        // Kiểm tra nếu có tham số story_id trong URL
        if (isset($_GET['story_id'])) {
            ...
            // Trả dữ liệu truyện cùng thể loại
            sendResponse(200, [
                'status' => 'success',
                'data' => $story
            ]);
        } else {
            // Nếu không có story_id, lấy tất cả truyện
            ...
            // Trả dữ liệu tất cả truyện với thông tin thể loại
            sendResponse(200, [
                'status' => 'success',
                'data' => $stories
            ]);
